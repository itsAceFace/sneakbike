    ...
    <v-container>
      <v-row justify="center">
        ...
        <v-col cols="8">
          ...
          <img
            src="@/assets/sneakbike_architecture.png"
            alt="Sneakbike Architecture"
          />
          <p>
          ...
          <p>
            <a href="https://www.terraform.io/intro/index.html" target="_blank"
              >Terraform</a
            >
          ...
          <ul>
            <li>
              An
              <a href="https://aws.amazon.com/account/" target="_blank"
                >AWS account</a
              >,
            </li>
          ...
          <p>
            Once you do this, <b>Exit and Restart Powershell as Admin</b> and
          ...
          <p>
            ...
            their data via
            <prism inline language="powershell"
              >rtmp://the_ip:1935/live/their_key</prism
            >.
          </p>

          <warning-card
            >Make sure to destroy the server when you're done otherwise you'll
            incur charges when you're not using the server!</warning-card
          >
        </v-col>
        <v-col></v-col>
      </v-row>
