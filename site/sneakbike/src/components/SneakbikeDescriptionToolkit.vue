<template>
  <div class="sneakbike-description-framework">
    <h1>What's the Sneakbike Toolkit?</h1>
    <p>
      The Sneakbike Toolkit (SBTK) is our open-source solution to having a
    ...
    <p>
      (<i
        ...
        <i>VLC Video Source</i> to display them on the stream.</i
      >)
    </p>
